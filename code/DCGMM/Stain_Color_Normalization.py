...
tf.flags.DEFINE_string("data_dir", "./StainStudy_Dataset/", "path to dataset")
tf.flags.DEFINE_string("tmpl_dir", "./tmpl_dir/", "path to template image(s)")
tf.flags.DEFINE_string("out_dir", "./out_dir/", "path to template image(s)")
